...
if __name__ == "__main__":
    # Below SQL commends performed in command line.
    # Memory Overage Errors when trying to do everything at once.
    # Had to split into multiple queries.
    ...
    # Combine reviews and restaurants. Inner Join.
    # Only return reviews from restaurants that have values
    # in both tables.
    ...
    # Pandas connection to final dataset.
    # Very large in sql ~85GB
    # Pretty small in pandas ~3.3MB per 10000 records.
    # Memory usage explodes when trying to query 100000 records.
